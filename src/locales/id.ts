const translations = {
  ...
  "all": "Semua",
  "animal": "Hewan",
  "animal_breed_interface": {
    "1": "Label"
  },
  "animal_category_interface": {
    "1": "Label",
    "2": "Untuk aqiqah",
    "3": "Gambar icon",
    "desc_2": "Hewan ini dapat digunakan untuk aqiqah",
    "deleted_3": "Gambar icon dihapus"
  },
  "animal_interface": {
    "1": "Kategori hewan",
    "2": "Ras hewan",
  ...
  "no_data_feedback": {
    ...
    "description": "Periksa kata kunci atau filter."
  },
  "not_found_feedback": {
    "title": "Tidak ditemukan",
  ...
  "show": "Tampilkan",
  "signin_loading_toast": {
    "title": "Login",
    "description": "Memverifikasi kredensial."
  },
  "signin_success_toast": {
    "title": "Login berhasil",
    "description": "Anda telah masuk."
  },
  "signin_wrong_credentials_toast": {
    "title": "Login gagal",
