...
const SelectBlogCategory = (props: Props) => {
  // Props
  ...
  function fetch(setOptions: any) {
    const config = {
      url: `/api/mamura/public-request/get-blog-category`,
      method: "get",
    };
  ...
  return (
    <SelectInput
      ...
      title={capsFirstLetterEachWord(l.blog_interface.category)}
      fetch={fetch}
      {...restProps}
    />
  );
...
export default SelectBlogCategory;
